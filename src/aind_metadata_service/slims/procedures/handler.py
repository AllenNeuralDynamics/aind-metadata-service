...
class ReagentData(BaseModel):
    """Consolidated reagent data from SLIMS histology procedures."""
...
class SlimsHistologyHandler(SlimsTableHandler):
    ...
    def _get_graph(self, specimen_id: str) -> Tuple[DiGraph, List[str]]:
        """
        Generate a Graph of the records from SLIMS for imaging experiment runs.
        Parameters
        ----------
        specimen_id: str
            The specimen_id to fetch the histology data for.
        Returns
        -------
