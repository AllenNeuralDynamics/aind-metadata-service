...
class TarsResponseHandler:
    ...
    @staticmethod
    def _map_prep_type_and_protocol(viral_prep_type: str) -> tuple[VirusPrepType, str]:
        ...
        if viral_prep_type == ViralPrepTypes.CRUDE_SOP.value:
            ...
            # TODO: add RABIES or UNKNOWN in aind_data_schema.procedures VirusPrepType
            prep_type = None
            prep_protocol = PrepProtocols.SOP_VC001.value
        elif viral_prep_type == ViralPrepTypes.CRUDE_PHP_SOP.value:
            # TODO: check mappings of the prep_protocol
            prep_type = VirusPrepType.CRUDE
    ...
    def _convert_datetime(date: str):
        ...
        if not date_pattern.match(date):
            print("Invalid date format. Please provide a date in the format: YYYY-MM-DDTHH:MM:SSZ")
            return None
    ...
    def _map_virus_aliases(aliases: list):
        """Map list of virus aliases to full_genome_name, material_id, and viral prep id"""
