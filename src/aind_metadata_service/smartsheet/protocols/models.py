...
class ProtocolNames(Enum):
    ...
    DELIPIDATION = "Tetrahydrofuran and Dichloromethane Delipidation of a Whole Mouse Brain"
    SBIP_DELIPADATION = "Aqueous (SBiP) Delipidation of a Whole Mouse Brain"
    GELATIN_PREVIOUS = "Whole Mouse Brain Delipidation, Immunolabeling, and Expansion Microscopy"
    INJECTION_NANOJECT = "Injection of Viral Tracers by Nanoject V.4"
    INJECTION_IONTOPHORESIS = "Stereotaxic Surgery for Delivery of Tracers by Iontophoresis V.3"
    ...
    PROTOCOL_COLLECTION = "Protocol Collection: Perfusing, Sectioning, IHC, Mounting and Coverslipping Mouse Brain Specimens"
    ...
    DURAGEL_APPLICATION = "Duragel application for acute electrophysiological recordings"
