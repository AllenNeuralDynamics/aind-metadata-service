...
from pydantic_xml import BaseXmlModel, element, ParsingError
...
class AnimalsCommon(SQLModel, table=True):
    ...
    class_def_id: Optional[int] = Field(default=None, alias="Class_Def_ID")
    ...
    facility_id: Optional[int] = Field(default=None, alias="Facility_ID")
    rent_item_id: Optional[int] = Field(default=None, alias="Rent_Item_ID")
    ...
    pedigree_number: Optional[int] = Field(
    ...
    order_id: Optional[int] = Field(default=None, alias="Order_ID")
    ...
    investigator_id: Optional[int] = Field(
        default=None, alias="Investigator_ID"
    )
    grant_id: Optional[int] = Field(default=None, alias="Grant_Id")
    # noinspection SpellCheckingInspection
    acuc_link_id: Optional[int] = Field(default=None, alias="ACUC_Link_ID")
    usda_code: Optional[str] = Field(default=None, alias="USDA_Code")
    species_id: Optional[int] = Field(default=None, alias="Species_ID")
    mouse_comment: Optional[str] = Field(default=None, alias="Mouse_Comment")
    paternal_index: Optional[int] = Field(default=None, alias="Paternal_Index")
    maternal_index: Optional[int] = Field(default=None, alias="Maternal_Index")
    ...
    litter_history_id: Optional[int] = Field(
        default=None, alias="Litter_History_ID"
    )
    foster_female_id: Optional[int] = Field(
        default=None, alias="Foster_Female_ID"
    )
    # noinspection SpellCheckingInspection
    vasectomized_male_id: Optional[int] = Field(
    ...
    strain_id: Optional[int] = Field(default=None, alias="Strain_ID")
    ...
    cage_id: Optional[int] = Field(default=None, alias="Cage_ID")
    cage_number: Optional[str] = Field(default=None, alias="Cage_Number")
    room_id: Optional[int] = Field(default=None, alias="Room_ID")
    rack_id: Optional[int] = Field(default=None, alias="Rack_ID")
    scanned_row: Optional[int] = Field(default=None, alias="Scanned_Row")
    scanned_col: Optional[int] = Field(default=None, alias="Scanned_Col")
    scanned_side: Optional[int] = Field(default=None, alias="Scanned_Side")
    animal_disposal_rent_item_id: Optional[int] = Field(
        default=None, alias="Animal_Disposal_Rent_Item_ID"
    )
    animal_transfer_rent_item_id: Optional[int] = Field(
    ...
    created_by: Optional[int] = Field(default=None, alias="Created_By")
    modified_by: Optional[int] = Field(default=None, alias="Modified_By")
...
class Groups(SQLModel, table=True):
    ...
    cost_service_id: Optional[int] = Field(
    ...
    class_def_id: Optional[int] = Field(default=None, alias="Class_Def_ID")
    class_values: Optional[str] = Field(default=None, alias="Class_Values")
    breeder_limit: Optional[int] = Field(default=None, alias="Breeder_Limit")
    breeder_limit_is_age: Optional[str] = Field(
        default=None, alias="Breeder_Limit_Is_Age"
    )
    wean_rent_item_id: Optional[int] = Field(
    ...
    cage_disposal_rent_item_id: Optional[int] = Field(
        default=None, alias="Cage_Disposal_Rent_Item_ID"
    )
    cage_transfer_rent_item_id: Optional[int] = Field(
...
class Species(SQLModel, table=True):
    ...
    created_by: Optional[int] = Field(default=None, alias="Created_By")
    modified_by: Optional[int] = Field(default=None, alias="Modified_By")
    animal_class_def_id: Optional[int] = Field(
        default=None, alias="Animal_Class_Def_ID"
    )
    background_animal_class_def_id: Optional[int] = Field(
        default=None, alias="Background_Animal_Class_Def_ID"
    )
    is_hidden: Optional[str] = Field(default=None, alias="Is_Hidden")
    males_per_cage: Optional[int] = Field(default=None, alias="Males_Per_Cage")
    females_per_cage: Optional[int] = Field(
...
class Subject(SQLModel):
    ...
    cage_id: Optional[int] = Field(default=None)
    room_id: Optional[int] = Field(default=None)
    paternal_id: Optional[int] = Field(default=None)
    paternal_class_values: Optional[MouseCustomClass] = Field(default=None)
    maternal_id: Optional[int] = Field(default=None)
    ...
    def parse_xml_string(cls, v: Any):
        """Parse xml string into a model. Only xml strings are expected
