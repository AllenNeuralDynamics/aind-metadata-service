...
class Burr1IntendedMeasurementBlue(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr1IntendedMeasurementBlue"""
...
class Burr1IntendedMeasurementGreen(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr1IntendedMeasurementGreen"""
...
class Burr1IntendedMeasurementIsosbestic(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr1IntendedMeasurementIsosbestic"""
...
class Burr1IntendedMeasurementRed(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr1IntendedMeasurementRed"""
...
class Burr2IntendedMeasurementBlue(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr2IntendedMeasurementBlue"""
...
class Burr2IntendedMeasurementGreen(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr2IntendedMeasurementGreen"""
...
class Burr2IntendedMeasurementIsosbestic(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr2IntendedMeasurementIsosbestic"""
...
class Burr2IntendedMeasurementRed(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr2IntendedMeasurementRed"""
...
class Burr3IntendedMeasurementBlue(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr3IntendedMeasurementBlue"""
...
class Burr3IntendedMeasurementGreen(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr3IntendedMeasurementGreen"""
...
class Burr3IntendedMeasurementIsosbestic(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr3IntendedMeasurementIsosbestic"""
...
class Burr3IntendedMeasurementRed(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr3IntendedMeasurementRed"""

    ENTER_CHOICE_1 = "Enter Choice #1"
    ENTER_CHOICE_2 = "Enter Choice #2"
    ENTER_CHOICE_3 = "Enter Choice #3"
...
class Burr4IntendedMeasurementBlue(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr4IntendedMeasurementBlue"""
...
class Burr4IntendedMeasurementGreen(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr4IntendedMeasurementGreen"""
...
class Burr4IntendedMeasurementIsosbestic(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr4IntendedMeasurementIsosbestic"""
...
class Burr4IntendedMeasurementRed(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr4IntendedMeasurementRed"""
...
class Burr5IntendedMeasurementBlue(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr5IntendedMeasurementBlue"""
...
class Burr5IntendedMeasurementGreen(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr5IntendedMeasurementGreen"""
...
class Burr5IntendedMeasurementIsosbestic(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr5IntendedMeasurementIsosbestic"""
...
class Burr5IntendedMeasurementRed(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr5IntendedMeasurementRed"""
...
class Burr6IntendedMeasurementBlue(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr6IntendedMeasurementBlue"""
...
class Burr6IntendedMeasurementGreen(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr6IntendedMeasurementGreen"""
...
class Burr6IntendedMeasurementIsosbestic(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr6IntendedMeasurementIsosbestic"""
...
class Burr6IntendedMeasurementRed(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Burr6IntendedMeasurementRed"""
...
class Inj1Iontopolarity(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Inj1Iontopolarity"""
...
class Inj2Iontopolarity(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Inj2Iontopolarity"""
...
class Inj3Iontopolarity(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Inj3Iontopolarity"""
...
class Inj4Iontopolarity(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Inj4Iontopolarity"""
...
class Inj5Iontopolarity(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Inj5Iontopolarity"""
...
class Inj6Iontopolarity(Enum, metaclass=OptionalEnumMeta):
    """Enum class for Inj6Iontopolarity"""
...
class Limsproject(Enum, metaclass=OptionalEnumMeta):
    ...
    M_IVSCCMET_LINK_AIBS = "mIVSCC-MET-Link_AIBS"
...
class Limstaskflow(Enum, metaclass=OptionalEnumMeta):
    ...
    EPHYS_DEV_VISUAL_BEHAVIOR = "Ephys Dev Visual Behavior 2"
    ...
    MSP_G_CA_MP8_TESTING_RO = "MSP GCaMP8 Testing (RO)"
    ...
    MSP_OM_FISH_GAD2_MESO = "MSP omFISH Gad2 Meso"
    ...
    MSP_OM_FISH_VIP_MESO_GAMM = "MSP omFISH Vip Meso (GammaStim)"
    ...
    OPEN_SCOPE_LOOP = "OpenScope Loop"
    ...
    OPEN_SCOPE_PSYCODE = "OpenScope Psycode"
    ...
    OPEN_SCOPE_TEXTURE_ACTIVE = "OpenScope Texture (Active)"
    OPEN_SCOPE_TEXTURE_PASSIV = "OpenScope Texture (Passive)"
    OPEN_SCOPE_VISION_2_HIPPO = "OpenScope Vision 2 Hippocampus"
    OPEN_SCOPE_VISMO = "OpenScope Vismo"
...
class Procedure(Enum, metaclass=OptionalEnumMeta):
    ...
    MOTOR_CTX = "Motor Ctx"
    SELECT = "Select..."
    SPINAL_CORD_INJ = "Spinal Cord INJ"
    ...
    UTERINE_HORN_INJECTION = "Uterine Horn Injection"
...
class Projectid(Enum, metaclass=OptionalEnumMeta):
    ...
    N_1020105420_CTY_PFAC = "102-01-054-20 CTY PFAC"
    ...
    N_1020106620_AIBS_CTY_CON = "102-01-066-20 AIBS CTY CONNECTS HIVE"
    N_1020106620_AIND_CTY_CON = "102-01-066-20 AIND CTY CONNECTS HIVE"
    ...
    N_1020107320_CTY_CT_PROJE = "102-01-073-20 CTY CT Projectome"
    N_1020107820_AIBS_VOCAL_C = "102-01-078-20 AIBS Vocal Circuit"
    N_1020107920_AIBS_CONNECT = (
    ...
    N_1020401620_CTY_DRAVET_P = "102-04-016-20 CTY Dravet Phase 3 WRF"
    N_1028800110_XPG_CORE_IMA = "102-88-001-10 XPG Core Imaging: BARseq"
    ...
    N_1100100110_PG_PROTEOMIC = "110-01-001-10 PG Proteomics"
    ...
    N_1220102220_AIND_PODGORS = "122-01-022-20 AIND Podgorski UM1"
    N_1228800210_XPG_CORE_NSB = "122-88-002-10 XPG Core NSB Behavior"
    N_1230100320_MOTOR_CIRCUI = "123-01-003-20 Motor Circuit Dysfunction in PD"
    N_1240100110_BRAIN_CONSCI = "124-01-001-10 Brain & Consciousness (Direct)"
    N_1250100110_SEA_HUB_SCIE = (
        "125-01-001-10 - SeaHub Scientific Activities (Direct)"
    )
    N_1270100110_CELL_CIRCUIT = "127-01-001-10 Cell & Circuit Therapeutics"
...
class NSBList(BaseModel, extra=Extra.allow):
    ...
    burr_1_intended_x0020: Optional[Burr1IntendedMeasurementRed] = Field(
        default=None,
        alias="Burr_x0020_1_x0020_intended_x0020",
        title="Burr 1 intended measurement red",
    )
    burr_1_intended_x0021: Optional[Burr1IntendedMeasurementGreen] = Field(
        default=None,
        alias="Burr_x0020_1_x0020_intended_x0021",
        title="Burr 1 intended measurement green",
    )
    burr_1_intended_x0022: Optional[Burr1IntendedMeasurementBlue] = Field(
        default=None,
        alias="Burr_x0020_1_x0020_intended_x0022",
        title="Burr 1 intended measurement blue",
    )
    burr_1_intended_x0023: Optional[Burr1IntendedMeasurementIsosbestic] = (
        Field(
            default=None,
    ...
    burr_2_intended_x0020: Optional[Burr2IntendedMeasurementRed] = Field(
        default=None,
        alias="Burr_x0020_2_x0020_intended_x0020",
        title="Burr 2 intended measurement red",
    )
    burr_2_intended_x0021: Optional[Burr2IntendedMeasurementGreen] = Field(
        default=None,
        alias="Burr_x0020_2_x0020_intended_x0021",
        title="Burr 2 intended measurement green",
    )
    burr_2_intended_x0022: Optional[Burr2IntendedMeasurementBlue] = Field(
        default=None,
        alias="Burr_x0020_2_x0020_intended_x0022",
        title="Burr 2 intended measurement blue",
    )
    burr_2_intended_x0023: Optional[Burr2IntendedMeasurementIsosbestic] = (
        Field(
            default=None,
    ...
    burr_3_intended_x0020: Optional[Burr3IntendedMeasurementRed] = Field(
        default=None,
        alias="Burr_x0020_3_x0020_intended_x0020",
        title="Burr 3 intended measurement red",
    )
    burr_3_intended_x0021: Optional[Burr3IntendedMeasurementGreen] = Field(
        default=None,
        alias="Burr_x0020_3_x0020_intended_x0021",
        title="Burr 3 intended measurement green",
    )
    burr_3_intended_x0022: Optional[Burr3IntendedMeasurementBlue] = Field(
        default=None,
        alias="Burr_x0020_3_x0020_intended_x0022",
        title="Burr 3 intended measurement blue",
    )
    burr_3_intended_x0023: Optional[Burr3IntendedMeasurementIsosbestic] = (
        Field(
            default=None,
    ...
    burr_4_intended_x0020: Optional[Burr4IntendedMeasurementRed] = Field(
        default=None,
        alias="Burr_x0020_4_x0020_intended_x0020",
        title="Burr 4 intended measurement red",
    )
    burr_4_intended_x0021: Optional[Burr4IntendedMeasurementGreen] = Field(
        default=None,
        alias="Burr_x0020_4_x0020_intended_x0021",
        title="Burr 4 intended measurement green",
    )
    burr_4_intended_x0022: Optional[Burr4IntendedMeasurementBlue] = Field(
        default=None,
        alias="Burr_x0020_4_x0020_intended_x0022",
        title="Burr 4 intended measurement blue",
    )
    burr_4_intended_x0023: Optional[Burr4IntendedMeasurementIsosbestic] = (
        Field(
            default=None,
    ...
    burr_5_intended_x0020: Optional[Burr5IntendedMeasurementRed] = Field(
        default=None,
        alias="Burr_x0020_5_x0020_intended_x0020",
        title="Burr 5 intended measurement red",
    )
    burr_5_intended_x0021: Optional[Burr5IntendedMeasurementGreen] = Field(
        default=None,
        alias="Burr_x0020_5_x0020_intended_x0021",
        title="Burr 5 intended measurement green",
    )
    burr_5_intended_x0022: Optional[Burr5IntendedMeasurementBlue] = Field(
        default=None,
        alias="Burr_x0020_5_x0020_intended_x0022",
        title="Burr 5 intended measurement blue",
    )
    burr_5_intended_x0023: Optional[Burr5IntendedMeasurementIsosbestic] = (
        Field(
            default=None,
    ...
    burr_6_intended_x0020: Optional[Burr6IntendedMeasurementRed] = Field(
        default=None,
        alias="Burr_x0020_6_x0020_intended_x0020",
        title="Burr 6 intended measurement red",
    )
    burr_6_intended_x0021: Optional[Burr6IntendedMeasurementGreen] = Field(
        default=None,
        alias="Burr_x0020_6_x0020_intended_x0021",
        title="Burr 6 intended measurement green",
    )
    burr_6_intended_x0022: Optional[Burr6IntendedMeasurementBlue] = Field(
        default=None,
        alias="Burr_x0020_6_x0020_intended_x0022",
        title="Burr 6 intended measurement blue",
    )
    burr_6_intended_x0023: Optional[Burr6IntendedMeasurementIsosbestic] = (
        Field(
            default=None,
    ...
    inj1_ionto_polarity: Optional[Inj1Iontopolarity] = Field(
        default=None, alias="Inj1IontoPolarity", title="Inj1IontoPolarity"
    )
    ...
    inj2_ionto_polarity: Optional[Inj2Iontopolarity] = Field(
        default=None, alias="Inj2IontoPolarity", title="Inj2IontoPolarity"
    )
    ...
    inj3_ionto_polarity: Optional[Inj3Iontopolarity] = Field(
        default=None, alias="Inj3IontoPolarity", title="Inj3IontoPolarity"
    )
    ...
    inj4_ionto_polarity: Optional[Inj4Iontopolarity] = Field(
        default=None, alias="Inj4IontoPolarity", title="Inj4IontoPolarity"
    )
    ...
    inj5_ionto_polarity: Optional[Inj5Iontopolarity] = Field(
        default=None, alias="Inj5IontoPolarity", title="Inj5IontoPolarity"
    )
    ...
    inj6_ionto_polarity: Optional[Inj6Iontopolarity] = Field(
        default=None, alias="Inj6IontoPolarity", title="Inj6IontoPolarity"
    )
