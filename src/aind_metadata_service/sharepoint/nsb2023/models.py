...
class Limstaskflow(Enum, metaclass=OptionalEnumMeta):
    ...
    MSP_U01_BRIDGING_FUNCTION = ('MSP U01 Bridging Function, Connectivity, and Transcriptomics')
...
class NSBList(BaseModel, extra=Extra.allow):
    ...
    age_at_injection: Optional[str] = Field(default=None, alias='Age_x0020_at_x0020_Injection', title='Age at Injection 1')
    ap2nd_inj: Optional[float] = Field(default=None, alias='AP2ndInj', title='Burr 2 A/P')
    author_id: Optional[int] = Field(default=None, alias='AuthorId')
    behavior: Optional[Behavior] = Field(default=None, alias='Behavior', title='Behavior')
    behavior_complete: Optional[datetime] = Field(default=None, alias='Behavior_x0020_Complete', title='Behavior Complete')
    behavior_type: Optional[BehaviorType] = Field(default=None, alias='Behavior_x0020_Type', title='Behavior Type')
    breg2_lamb: Optional[float] = Field(default=None, alias='Breg2Lamb', title='Bregma to Lambda')
    burr1_injection_devi: Optional[Burr1InjectionDevice] = Field(default=None, alias='Burr1_x0020_Injection_x0020_Devi', title='Burr1 Injection Device')
    burr1_perform_during: Optional[Burr1PerformDuring] = Field(default=None, alias='Burr1_x0020_Perform_x0020_During', title='Burr1 Perform During')
    burr1_virus_biosafte: Optional[Burr1VirusBiosafteyLevelBsl] = Field(default=None, alias='Burr1_x0020_Virus_x0020_Biosafte', title='Burr1 Virus Biosaftey Level (BSL)', description='BSL & Material injected. If other PI must provide material in requestor comments.')
    burr2_injection_devi: Optional[Burr2InjectionDevice] = Field(default=None, alias='Burr2_x0020_Injection_x0020_Devi', title='Burr2 Injection Device')
    burr2_perform_during: Optional[Burr2PerformDuring] = Field(default=None, alias='Burr2_x0020_Perform_x0020_During', title='Burr2 Perform During')
    burr2_status: Optional[Burr2Status] = Field(default=None, alias='Burr2_x0020_Status', title='Burr2 Status')
    burr2_virus_biosafte: Optional[Burr2VirusBiosafteyLevelBsl] = Field(default=None, alias='Burr2_x0020_Virus_x0020_Biosafte', title='Burr2 Virus Biosaftey Level (BSL)', description='BSL & Material injected. If other PI must provide material in requestor comments.')
    burr3_a_p: Optional[float] = Field(default=None, alias='Burr3_x0020_A_x002f_P', title='Burr3 A/P')
    burr3_d_v: Optional[float] = Field(default=None, alias='Burr3_x0020_D_x002f_V', title='Burr3 D/V 1')
    burr3_injection_devi: Optional[Burr3InjectionDevice] = Field(default=None, alias='Burr3_x0020_Injection_x0020_Devi', title='Burr3 Injection Device')
    burr3_m_l: Optional[float] = Field(default=None, alias='Burr3_x0020_M_x002f_L', title='Burr3 M/L')
    burr3_perform_during: Optional[Burr3PerformDuring] = Field(default=None, alias='Burr3_x0020_Perform_x0020_During', title='Burr3 Perform During')
    burr3_status: Optional[Burr3Status] = Field(default=None, alias='Burr3_x0020_Status', title='Burr3 Status')
    burr3_virus_biosafet: Optional[Burr3VirusBiosafetyLevelBsl] = Field(default=None, alias='Burr3_x0020_Virus_x0020_Biosafet', title='Burr3 Virus Biosafety Level (BSL)', description='BSL & Material injected. If other PI must provide material in requestor comments.')
    burr4_a_p: Optional[float] = Field(default=None, alias='Burr4_x0020_A_x002f_P', title='Burr4 A/P')
    burr4_d_v: Optional[float] = Field(default=None, alias='Burr4_x0020_D_x002f_V', title='Burr4 D/V 1')
    burr4_injection_devi: Optional[Burr4InjectionDevice] = Field(default=None, alias='Burr4_x0020_Injection_x0020_Devi', title='Burr4 Injection Device')
    burr4_m_l: Optional[float] = Field(default=None, alias='Burr4_x0020_M_x002f_L', title='Burr4 M/L')
    burr4_perform_during: Optional[Burr4PerformDuring] = Field(default=None, alias='Burr4_x0020_Perform_x0020_During', title='Burr4 Perform During')
    burr4_status: Optional[Burr4Status] = Field(default=None, alias='Burr4_x0020_Status', title='Burr4 Status')
    burr4_virus_biosafte: Optional[Burr4VirusBiosafteyLevelBsl] = Field(default=None, alias='Burr4_x0020_Virus_x0020_Biosafte', title='Burr4 Virus Biosaftey Level (BSL)', description='BSL & Material injected. If other PI must provide material in requestor comments.')
    burr5_injection_devi: Optional[Burr5InjectionDevice] = Field(default=None, alias='Burr5_x0020_Injection_x0020_Devi', title='Burr5 Injection Device')
    burr5_perform_during: Optional[Burr5PerformDuring] = Field(default=None, alias='Burr5_x0020_Perform_x0020_During', title='Burr5 Perform During')
    burr5_status: Optional[Burr5Status] = Field(default=None, alias='Burr5_x0020_Status', title='Burr5 Status')
    burr5_virus_biosafte: Optional[Burr5VirusBiosafteyLevelBsl] = Field(default=None, alias='Burr5_x0020_Virus_x0020_Biosafte', title='Burr5 Virus Biosaftey Level (BSL)')
    burr6_injection_devi: Optional[Burr6InjectionDevice] = Field(default=None, alias='Burr6_x0020_Injection_x0020_Devi', title='Burr6 Injection Device')
    burr6_perform_during: Optional[Burr6PerformDuring] = Field(default=None, alias='Burr6_x0020_Perform_x0020_During', title='Burr6 Perform During', description='')
    burr6_status: Optional[Burr6Status] = Field(default=None, alias='Burr6_x0020_Status', title='Burr6 Status')
    burr6_virus_biosafte: Optional[Burr6VirusBiosafteyLevelBsl] = Field(default=None, alias='Burr6_x0020_Virus_x0020_Biosafte', title='Burr6 Virus Biosaftey Level (BSL)')
    burr_1_d_v_x00: Optional[float] = Field(default=None, alias='Burr_x0020_1_x0020_D_x002f_V_x00', title='Burr 1 D/V 3')
    burr_1_dv_2: Optional[float] = Field(default=None, alias='Burr_x0020_1_x0020_DV_x0020_2', title='Burr 1 D/V 2')
    burr_1_fiber_t: Optional[Burr1FiberType] = Field(default=None, alias='Burr_x0020_1_x0020_Fiber_x0020_t', title='Burr 1 Fiber type')
    burr_2_d_v_x000: Optional[float] = Field(default=None, alias='Burr_x0020_2_x0020_D_x002f_V_x000', title='Burr 2 D/V 3')
    burr_2_d_v_x00: Optional[float] = Field(default=None, alias='Burr_x0020_2_x0020_D_x002f_V_x00', title='Burr 2 D/V 2')
    burr_2_fiber_t: Optional[Burr2FiberType] = Field(default=None, alias='Burr_x0020_2_x0020_Fiber_x0020_T', title='Burr 2 Fiber Type')
    burr_3_angle: Optional[float] = Field(default=None, alias='Burr_x0020_3_x0020_Angle', title='Burr 3 Angle')
    burr_3_d_v_x000: Optional[float] = Field(default=None, alias='Burr_x0020_3_x0020_D_x002f_V_x000', title='Burr 3 D/V 3')
    burr_3_d_v_x00: Optional[float] = Field(default=None, alias='Burr_x0020_3_x0020_D_x002f_V_x00', title='Burr 3 D/V 2')
    burr_3_fiber_t: Optional[Burr3FiberType] = Field(default=None, alias='Burr_x0020_3_x0020_Fiber_x0020_T', title='Burr 3 Fiber Type')
    burr_3_hemisphere: Optional[Burr3Hemisphere] = Field(default=None, alias='Burr_x0020_3_x0020_Hemisphere', title='Burr 3 Hemisphere')
    burr_4_angle: Optional[float] = Field(default=None, alias='Burr_x0020_4_x0020_Angle', title='Burr 4 Angle')
    burr_4_d_v_x000: Optional[float] = Field(default=None, alias='Burr_x0020_4_x0020_D_x002f_V_x000', title='Burr 4 D/V 3')
    burr_4_d_v_x00: Optional[float] = Field(default=None, alias='Burr_x0020_4_x0020_D_x002f_V_x00', title='Burr 4 D/V 2')
    burr_4_fiber_t: Optional[Burr4FiberType] = Field(default=None, alias='Burr_x0020_4_x0020_Fiber_x0020_T', title='Burr 4 Fiber Type')
    burr_4_hemisphere: Optional[Burr4Hemisphere] = Field(default=None, alias='Burr_x0020_4_x0020_Hemisphere', title='Burr 4 Hemisphere')
    burr_5_a_p: Optional[float] = Field(default=None, alias='Burr_x0020_5_x0020_A_x002f_P', title='Burr 5 A/P')
    burr_5_angle: Optional[float] = Field(default=None, alias='Burr_x0020_5_x0020_Angle', title='Burr 5 Angle')
    burr_5_d_v_x000: Optional[float] = Field(default=None, alias='Burr_x0020_5_x0020_D_x002f_V_x000', title='Burr 5 D/V 2')
    burr_5_d_v_x001: Optional[float] = Field(default=None, alias='Burr_x0020_5_x0020_D_x002f_V_x001', title='Burr 5 D/V 3')
    burr_5_d_v_x00: Optional[float] = Field(default=None, alias='Burr_x0020_5_x0020_D_x002f_V_x00', title='Burr 5 D/V 1')
    burr_5_fiber_t: Optional[Burr5FiberType] = Field(default=None, alias='Burr_x0020_5_x0020_Fiber_x0020_t', title='Burr 5 Fiber type')
    burr_5_hemisphere: Optional[Burr5Hemisphere] = Field(default=None, alias='Burr_x0020_5_x0020_Hemisphere', title='Burr 5 Hemisphere')
    burr_5_m_l: Optional[float] = Field(default=None, alias='Burr_x0020_5_x0020_M_x002f_L', title='Burr 5 M/L')
    burr_6_a_p: Optional[float] = Field(default=None, alias='Burr_x0020_6_x0020_A_x002f_P', title='Burr 6 A/P')
    burr_6_angle: Optional[float] = Field(default=None, alias='Burr_x0020_6_x0020_Angle', title='Burr 6 Angle')
    burr_6_d_v_x000: Optional[float] = Field(default=None, alias='Burr_x0020_6_x0020_D_x002f_V_x000', title='Burr 6 D/V 2')
    burr_6_d_v_x001: Optional[float] = Field(default=None, alias='Burr_x0020_6_x0020_D_x002f_V_x001', title='Burr 6 D/V 3')
    burr_6_d_v_x00: Optional[float] = Field(default=None, alias='Burr_x0020_6_x0020_D_x002f_V_x00', title='Burr 6 D/V 1')
    burr_6_fiber_t: Optional[Burr6FiberType] = Field(default=None, alias='Burr_x0020_6_x0020_Fiber_x0020_t', title='Burr 6 Fiber type')
    burr_6_hemisphere: Optional[Burr6Hemisphere] = Field(default=None, alias='Burr_x0020_6_x0020_Hemisphere', title='Burr 6 Hemisphere')
    burr_6_m_l: Optional[float] = Field(default=None, alias='Burr_x0020_6_x0020_M_x002f_L', title='Burr 6 M/L')
    burr_hole_1: Optional[BurrHole1] = Field(default=None, alias='Burr_x0020_hole_x0020_1', title='Burr hole 1')
    burr_hole_1_st: Optional[Burr1Status] = Field(default=None, alias='Burr_x0020_Hole_x0020_1_x0020_st', title='Burr1 Status')
    burr_hole_2: Optional[BurrHole2] = Field(default=None, alias='Burr_x0020_hole_x0020_2', title='Burr hole 2')
    burr_hole_3: Optional[BurrHole3] = Field(default=None, alias='Burr_x0020_hole_x0020_3', title='Burr hole 3')
    burr_hole_4: Optional[BurrHole4] = Field(default=None, alias='Burr_x0020_hole_x0020_4', title='Burr hole 4')
    burr_hole_5: Optional[BurrHole5] = Field(default=None, alias='Burr_x0020_hole_x0020_5', title='Burr hole 5')
    burr_hole_6: Optional[BurrHole6] = Field(default=None, alias='Burr_x0020_hole_x0020_6', title='Burr hole 6')
    color_tag: Optional[str] = Field(default=None, alias='_ColorTag', title='Color Tag')
    com_coplanar: Optional[Laceration] = Field(default=None, alias='ComCoplanar', title='Laceration')
    com_damage: Optional[Hematoma] = Field(default=None, alias='ComDamage', title='Hematoma')
    com_durotomy: Optional[Durotomy] = Field(default=None, alias='ComDurotomy', title='Durotomy')
    com_sinusbleed: Optional[SinusBleed] = Field(default=None, alias='ComSinusbleed', title='Sinus Bleed')
    com_swelling: Optional[EdemaSwelling] = Field(default=None, alias='ComSwelling', title='Edema (Swelling)')
    com_window: Optional[WindowPlacment] = Field(default=None, alias='ComWindow', title='Window Placment')
    compliance_asset_id: Optional[str] = Field(default=None, alias='ComplianceAssetId', title='Compliance Asset Id')
    contusion: Optional[Contusion] = Field(default=None, alias='Contusion', title='Contusion')
    craniotomy_perform_d: Optional[CraniotomyPerformDuring] = Field(default=None, alias='Craniotomy_x0020_Perform_x0020_D', title='Craniotomy Perform During')
    craniotomy_type: Optional[CraniotomyType] = Field(default=None, alias='CraniotomyType', title='Craniotomy Type')
    created: Optional[datetime] = Field(default=None, alias='Created', title='Created')
    date1st_injection: Optional[datetime] = Field(default=None, alias='Date1stInjection', title='Date of Follow up Surgery')
    date_of_birth: Optional[datetime] = Field(default=None, alias='Date_x0020_of_x0020_Birth', title='Date of Birth')
    date_of_surgery: Optional[datetime] = Field(default=None, alias='Date_x0020_of_x0020_Surgery', title='Date of Initial Surgery')
    date_range_start: Optional[datetime] = Field(default=None, alias='DateRangeStart', title='DateRangeStart')
    dv2nd_inj: Optional[float] = Field(default=None, alias='DV2ndInj', title='Burr 2 D/V 1')
    editor_id: Optional[int] = Field(default=None, alias='EditorId')
    fiber_implant1_dv: Optional[float] = Field(default=None, alias='FiberImplant1DV', title='Fiber Implant1 D/V')
    fiber_implant1_lengt: Optional[FiberImplant1Length] = Field(default=None, alias='Fiber_x0020_Implant1_x0020_Lengt', title='Fiber Implant1 Length')
    fiber_implant2_dv: Optional[float] = Field(default=None, alias='FiberImplant2DV', title='Fiber Implant2 D/V')
    fiber_implant2_lengt: Optional[FiberImplant2Length] = Field(default=None, alias='Fiber_x0020_Implant2_x0020_Lengt', title='Fiber Implant2 Length')
    fiber_implant3_d_x00: Optional[float] = Field(default=None, alias='Fiber_x0020_Implant3_x0020_D_x00', title='Fiber Implant3 D/V')
    fiber_implant3_lengt: Optional[FiberImplant3Length] = Field(default=None, alias='Fiber_x0020_Implant3_x0020_Lengt', title='Fiber Implant3 Length')
    fiber_implant4_d_x00: Optional[float] = Field(default=None, alias='Fiber_x0020_Implant4_x0020_D_x00', title='Fiber Implant4 D/V')
    fiber_implant4_lengt: Optional[FiberImplant4Length] = Field(default=None, alias='Fiber_x0020_Implant4_x0020_Lengt', title='Fiber Implant4 Length')
    fiber_implant5_d_x00: Optional[float] = Field(default=None, alias='Fiber_x0020_Implant5_x0020_D_x00', title='Fiber Implant5 D/V')
    fiber_implant5_lengt: Optional[FiberImplant5Length] = Field(default=None, alias='Fiber_x0020_Implant5_x0020_Lengt', title='Fiber Implant5 Length')
    fiber_implant6_d_x00: Optional[float] = Field(default=None, alias='Fiber_x0020_Implant6_x0020_D_x00', title='Fiber Implant6 D/V')
    fiber_implant6_lengt: Optional[FiberImplant6Length] = Field(default=None, alias='Fiber_x0020_Implant6_x0020_Lengt', title='Fiber Implant6 Length')
    first_inj_recovery: Optional[float] = Field(default=None, alias='FirstInjRecovery', title='Follow up Recovery')
    first_injection_iso_durat: Optional[float] = Field(default=None, alias='FirstInjectionIsoDuration', title='Follow up Iso Duration')
    first_injection_weight_af: Optional[float] = Field(default=None, alias='FirstInjectionWeightAfter', title='Follow up Weight After')
    first_injection_weight_be: Optional[float] = Field(default=None, alias='FirstInjectionWeightBefor', title='Follow up Weight Before')
    headpost: Optional[Headpost] = Field(default=None, alias='Headpost', title='Headpost')
    headpost_perform_dur: Optional[HeadpostPerformDuring] = Field(default=None, alias='Headpost_x0020_Perform_x0020_Dur', title='Headpost Perform During')
    headpost_type: Optional[Well] = Field(default=None, alias='HeadpostType', title='Well')
    hemisphere2nd_inj: Optional[Burr2Hemisphere] = Field(default=None, alias='Hemisphere2ndInj', title='Burr 2 Hemisphere')
    hp_iso_level: Optional[float] = Field(default=None, alias='HPIsoLevel', title='Initial Iso Level')
    hp_recovery: Optional[float] = Field(default=None, alias='HPRecovery', title='Initial Recovery')
    hp_surgeon_comments: Optional[str] = Field(default=None, alias='HPSurgeonComments', title='Surgeon Comments')
    hp_work_station: Optional[InitialWorkStation] = Field(default=None, alias='HpWorkStation', title='Initial Work Station')
    iacuc_protocol: Optional[IacucProtocol] = Field(default=None, alias='IACUC_x0020_Protocol_x0020__x002', title='IACUC Protocol', description='Create a secondary List for Protocols and link to drugs')
    ...
    inj1_angle_v2: Optional[float] = Field(default=None, alias='Inj1Angle_v2', title='Burr 1 Angle')
    ...
    inj1_type: Optional[Inj1Type] = Field(default=None, alias='Inj1Type', title='Inj1Type')
    inj1_virus_strain_rt: Optional[str] = Field(default=None, alias='Inj1VirusStrain_rt', title='Inj1VirusStrain_rt')
    inj1volperdepth: Optional[float] = Field(default=None, alias='inj1volperdepth', title='inj1volperdepth')
    inj2_alternating_time: Optional[str] = Field(default=None, alias='Inj2AlternatingTime', title='Inj2AlternatingTime')
    inj2_angle_v2: Optional[float] = Field(default=None, alias='Inj2Angle_v2', title='Burr 2 Angle')
    ...
    inj2_type: Optional[Inj2Type] = Field(default=None, alias='Inj2Type', title='Inj2Type')
    inj2_virus_strain_rt: Optional[str] = Field(default=None, alias='Inj2VirusStrain_rt', title='Inj2VirusStrain_rt')
    inj2volperdepth: Optional[float] = Field(default=None, alias='inj2volperdepth', title='inj2volperdepth')
    ...
    inj3_type: Optional[Inj3Type] = Field(default=None, alias='Inj3Type', title='Inj3Type')
    inj3ret_setting: Optional[Inj3Retsetting] = Field(default=None, alias='Inj3retSetting', title='Inj3retSetting')
    inj3volperdepth: Optional[float] = Field(default=None, alias='Inj3volperdepth', title='Inj3volperdepth')
    ...
    inj4_type: Optional[Inj4Type] = Field(default=None, alias='Inj4Type', title='Inj4Type')
    inj4_virus_strain_rt: Optional[str] = Field(default=None, alias='Inj4VirusStrain_rt', title='Inj4VirusStrain_rt')
    inj4ret_setting: Optional[Inj4Retsetting] = Field(default=None, alias='Inj4retSetting', title='Inj4retSetting')
    inj4volperdepth: Optional[float] = Field(default=None, alias='Inj4volperdepth', title='Inj4volperdepth')
    ...
    inj5_type: Optional[Inj5Type] = Field(default=None, alias='Inj5Type', title='Inj5Type')
    inj5_virus_strain_rt: Optional[str] = Field(default=None, alias='Inj5VirusStrain_rt', title='Inj5VirusStrain_rt')
    inj5ret_setting: Optional[Inj5Retsetting] = Field(default=None, alias='Inj5retSetting', title='Inj5retSetting')
    inj5volperdepth: Optional[float] = Field(default=None, alias='inj5volperdepth', title='inj5volperdepth')
    ...
    inj6_type: Optional[Inj6Type] = Field(default=None, alias='Inj6Type', title='Inj6Type')
    inj6_virus_strain_rt: Optional[str] = Field(default=None, alias='Inj6VirusStrain_rt', title='Inj6VirusStrain_rt')
    inj6ret_setting: Optional[Inj6Retsetting] = Field(default=None, alias='Inj6retSetting', title='Inj6retSetting')
    inj6volperdepth: Optional[float] = Field(default=None, alias='inj6volperdepth', title='inj6volperdepth')
    inj_virus_strain_rt: Optional[str] = Field(default=None, alias='InjVirusStrain_rt', title='Inj3VirusStrain_rt')
    ionto_number_inj1: Optional[InitialIontoNumber] = Field(default=None, alias='IontoNumberInj1', title='Initial Ionto Number')
    ionto_number_inj2: Optional[FolowUpIontoNumber] = Field(default=None, alias='IontoNumberInj2', title='Folow up Ionto Number')
    iso_on: Optional[float] = Field(default=None, alias='Iso_x0020_On', title='Initial Iso Duration')
    lab_tracks_group: Optional[str] = Field(default=None, alias='LabTracks_x0020_Group', title='LabTracks Group')
    lab_tracks_id1: Optional[str] = Field(default=None, alias='LabTracks_x0020_ID1', title='LabTracks ID')
    lab_tracks_requestor: Optional[str] = Field(default=None, alias='LabTracks_x0020_Requestor', title='LabTracks Requestor', description='Who requested the animal in LabTracks')
    li_ms_required: Optional[LimsRequired] = Field(default=None, alias='LIMs_x0020_Required', title='LIMS Required', description='Is LIMS Entry required')
    ...
    ml2nd_inj: Optional[float] = Field(default=None, alias='ML2ndInj', title='Burr 2 M/L')
    modified: Optional[datetime] = Field(default=None, alias='Modified', title='Modified')
    nanoject_number_inj10: Optional[InitialNanojectNumber] = Field(default=None, alias='NanojectNumberInj10', title='Initial Nanoject Number')
    nanoject_number_inj2: Optional[FollowUpNanojectNumber] = Field(default=None, alias='NanojectNumberInj2', title='Follow up Nanoject Number')
    of_burr: Optional[OfBurrHoles] = Field(default=None, alias='_x0023__x0020_of_x0020_Burr_x002', title='# of Burr Holes')
    pedigree_name: Optional[str] = Field(default=None, alias='PedigreeName', title='Pedigree Name')
    procedure: Optional[Procedure] = Field(default=None, alias='Procedure', title='Procedure', description='Procedure, Specific T3')
    procedure_family: Optional[ProcedureCategory] = Field(default=None, alias='Procedure_x0020_Family', title='Procedure Category', description='Procedure Family T1')
    procedure_slots: Optional[ProcedureSlots] = Field(default=None, alias='Procedure_x0020_Slots', title='Procedure Slots', description='Sinlge or mutpile surgical slots')
    procedure_t2: Optional[PhysiologyType] = Field(default=None, alias='Procedure_x0020_T2', title='Physiology Type', description='Procedure Imaging paradigm T2')
    project_id: Optional[Projectid] = Field(default=None, alias='ProjectID', title='ProjectID')
    ret_setting0: Optional[Inj1Retsetting] = Field(default=None, alias='retSetting0', title='Inj1retSetting')
    ret_setting1: Optional[Inj2Retsetting] = Field(default=None, alias='retSetting1', title='Inj2retSetting')
    round1_inj_isolevel: Optional[float] = Field(default=None, alias='Round1InjIsolevel', title='Follow up Iso Level')
    sex: Optional[Sex] = Field(default=None, alias='Sex', title='Sex')
    surgery_status: Optional[SurgeryStatus] = Field(default=None, alias='SurgeryStatus', title='Surgery Status')
    ...
    virus_a_p: Optional[float] = Field(default=None, alias='Virus_x0020_A_x002f_P', title='Burr 1 A/P')
    virus_d_v: Optional[float] = Field(default=None, alias='Virus_x0020_D_x002f_V', title='Burr  1 D/V 1')
    virus_hemisphere: Optional[Burr1Hemisphere] = Field(default=None, alias='Virus_x0020_Hemisphere', title='Burr 1 Hemisphere')
    virus_m_l: Optional[float] = Field(default=None, alias='Virus_x0020_M_x002f_L', title='Burr  1 M/L')
    weight_after_surgery: Optional[float] = Field(default=None, alias='Weight_x0020_after_x0020_Surgery', title='Initial Weight after')
    weight_before_surger: Optional[float] = Field(default=None, alias='Weight_x0020_before_x0020_Surger', title='Initial Weight before')
    work_station1st_injection: Optional[FollowUpWorkstation] = Field(default=None, alias='WorkStation1stInjection', title='Follow up Workstation')