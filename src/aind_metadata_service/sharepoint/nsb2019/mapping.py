...
class MappedNSBList:
    ...
    def _parse_alt_time_str(self, alt_time_str: Optional[str]) -> Optional[float]:
    ...
    def _parse_length_of_time_str(self, len_of_time_str: Optional[str]) -> Optional[float]:
