...
from aind_metadata_service.sharepoint.client import ListVersions
...
class Examples:
    list_item_json = ({
        ...
        'LIMS_x0020_link': "<a href='http://lims2/specimens?search650102'>Search</a>",
    ...
    procedures1 = (
        Procedures(describedBy='https://raw.githubusercontent.com/AllenNeuralDynamics/aind-data-schema/main/site-packages/aind_data_schema/procedures.py',
...
class TestSharepointClient(unittest.TestCase):
    client = SharePointClient(site_url="a_url",
                              client_id="an_id",
