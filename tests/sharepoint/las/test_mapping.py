...
from aind_metadata_service.sharepoint.las.mapping import MappedLASList

if os.getenv("LOG_LEVEL"):  # pragma: no cover
    logging.basicConfig(level=os.getenv("LOG_LEVEL"))

TEST_DIR = Path(os.path.dirname(os.path.realpath(__file__))) / ".." / ".."
DIR_RAW = TEST_DIR / "resources" / "sharepoint" / "las" / "raw"
DIR_MAP = TEST_DIR / "resources" / "sharepoint" / "las" / "mapped"
