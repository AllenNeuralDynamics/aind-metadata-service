...
class TestSlimsClient(unittest.IsolatedAsyncioTestCase):
    ...
    @patch(
        "aind_metadata_service.slims.client.SlimsClient._is_instrument_model"
    )
    def test_extract_models_from_response(
        self,
        mock_is_instrument,
        ...
        mock_get_file_response.return_value.json.return_value = (
    ...
    def test_get_model_response_success(
        self, mock_extract_models_from_response, mock_get_record_response
    ):
        ...
        mock_extract_models_from_response.return_value = [
        ...
        self.assertEqual(
            self.client.get_model_response(input_id).status_code,
            expected_model_response.status_code,
        )
        self.assertEqual(
            self.client.get_model_response(input_id).aind_models,
    ...
    def test_get_model_response_exception(self, mock_get_record_response):
        ...
        self.assertEqual(
            self.client.get_model_response("12345").status_code,
