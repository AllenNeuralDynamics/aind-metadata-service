...
with aind_metadata_service_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Dataverse Table Info
        api_response = api_instance.get_dataverse_table_info()
...
with aind_metadata_service_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Exaspim Procedures
        api_response = api_instance.get_exaspim_procedures(subject_id)
...
with aind_metadata_service_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Investigators
        api_response = api_instance.get_investigators(project_name)
...
with aind_metadata_service_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Labtracks Subject
        api_response = api_instance.get_labtracks_subject(subject_id)
...
with aind_metadata_service_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Labtracks Subject By Protocol Number
        api_response = api_instance.get_labtracks_subject_by_protocol_number(protocol_number)
