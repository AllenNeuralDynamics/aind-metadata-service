...
class TestInjectionMaterialsMapping(unittest.TestCase):
    """Class to test methods for InjectionMaterialsMapper"""
    ...
    def setUp(cls):
        ...
        cls.mapper = InjectionMaterialsMapper(
            tars_prep_lot_data=prep_lot_data, tars_virus_data=virus_data
        )
    ...
    def test_map_virus_information_empty(self):
        ...
        mapper = InjectionMaterialsMapper(
            tars_prep_lot_data=self.mapper.prep_lot_data, tars_virus_data=[]
        )
        self.assertEqual(
    ...
    def test_map_virus_information_first_rrid_edge_case(self):
        ...
        mapper = InjectionMaterialsMapper(
            tars_prep_lot_data=self.mapper.prep_lot_data,
            tars_virus_data=[VirusData(rr_id="abc")],
        )
        self.assertEqual(
    ...
    def test_create_addgene_pid_name(self):
        ...
        tars_virus_info_2 = TarsVirusInformation(
            name="pAAV-7x-TRE-tDTomato",
            plasmid_alias="ExP300001",
            addgene_id=None,
            rrid=None,
        )
        tars_virus_info_3 = TarsVirusInformation(
            name="pAAV-7x-TRE-tDTomato",
            plasmid_alias="ExP300001",
            addgene_id="191207",
            rrid="MGI_191207",
        )
        expected_pid_name_1 = PIDName(
            name="pAAV-7x-TRE-tDTomato",
            registry=Registry.ADDGENE,
            registry_identifier="191207",
        )
        expected_pid_name_2 = PIDName(
            name="pAAV-7x-TRE-tDTomato",
            registry=None,
            registry_identifier=None,
        )
        expected_pid_name_3 = PIDName(
            name="pAAV-7x-TRE-tDTomato",
            registry="MGI_191207",
            registry_identifier="191207",
        )
        ...
        self.assertEqual(
            expected_pid_name_2,
            self.mapper._create_addgene_pid_name(tars_virus_info_2),
        )
        self.assertEqual(
            expected_pid_name_3,
            self.mapper._create_addgene_pid_name(tars_virus_info_3),
        )
        self.assertIsNone(
    ...
    def test_map_to_viral_material_information_invalid(self):
        ...
        mapper = InjectionMaterialsMapper(
            tars_prep_lot_data=PrepLotData(lot="abc")
        )
