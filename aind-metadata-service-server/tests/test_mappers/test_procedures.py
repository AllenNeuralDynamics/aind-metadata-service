...
class TestProcedures(unittest.TestCase):
    ...
    def test_map_responses_to_aind_procedures(self):
        ...
        self.assertEqual(len(procedures.specimen_procedures), 2)
    ...
    def test_get_protocols_list(self):
        ...
        surgery = Surgery.model_construct(procedures=[nanoject_inj, cran])
        procedures = Procedures(
    ...
    def test_map_slims_info_to_water_restrictions(self):
        ...
        output = mapper.map_slims_response_to_aind_water_restrictions()
        expected_output = [
