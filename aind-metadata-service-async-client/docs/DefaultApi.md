...
async with aind_metadata_service_async_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Dataverse Table
        api_response = await api_instance.get_dataverse_table(entity_set_table_name, columns=columns, filter=filter)
...
```python
import aind_metadata_service_async_client
from aind_metadata_service_async_client.models.mouse_weight_data import MouseWeightData
from aind_metadata_service_async_client.rest import ApiException
from pprint import pprint
...
async with aind_metadata_service_async_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Mouse Weight Records
        api_response = await api_instance.get_mouse_weight_records(subject_id, acquisition_datetime=acquisition_datetime)
