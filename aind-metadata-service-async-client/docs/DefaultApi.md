...
async with aind_metadata_service_async_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_metadata_service_async_client.DefaultApi(api_client)
    workflow = aind_metadata_service_async_client.AindMetadataServiceServerRoutesSlimsSlimsWorkflow() # AindMetadataServiceServerRoutesSlimsSlimsWorkflow | The SLIMS workflow to query.
