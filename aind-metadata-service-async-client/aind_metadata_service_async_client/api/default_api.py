...
class DefaultApi:
    ...
    @validate_call
    async def get_dataverse_table_with_http_info(
        self,
        entity_set_table_name: Annotated[StrictStr, Field(description="The entity set name of the table to fetch")],
        columns: Annotated[Optional[StrictStr], Field(description="Comma-separated column names to select from the table")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="OData-style filter expression")] = None,
    ...
    @validate_call
    async def get_dataverse_table_without_preload_content(
        self,
        entity_set_table_name: Annotated[StrictStr, Field(description="The entity set name of the table to fetch")],
        columns: Annotated[Optional[StrictStr], Field(description="Comma-separated column names to select from the table")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="OData-style filter expression")] = None,
    ...
    @validate_call
    async def get_dataverse_table_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_dataverse_table_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_exaspim_procedures_with_http_info(
        self,
        subject_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_exaspim_procedures_without_preload_content(
        self,
        subject_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_investigators_with_http_info(
        self,
        project_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_investigators_without_preload_content(
        self,
        project_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_labtracks_subject_with_http_info(
        self,
        subject_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_labtracks_subject_without_preload_content(
        self,
        subject_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_labtracks_subject_by_protocol_number_with_http_info(
        self,
        protocol_number: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_labtracks_subject_by_protocol_number_without_preload_content(
        self,
        protocol_number: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_mouse_weight_records_with_http_info(
        self,
        subject_id: Annotated[StrictStr, Field(description="The subject ID to fetch mouse weight records for")],
        acquisition_datetime: Annotated[Optional[datetime], Field(description="Filter records by acquisition datetime (ISO format)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_mouse_weight_records_without_preload_content(
        self,
        subject_id: Annotated[StrictStr, Field(description="The subject ID to fetch mouse weight records for")],
        acquisition_datetime: Annotated[Optional[datetime], Field(description="Filter records by acquisition datetime (ISO format)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_smartsheet_funding_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_smartsheet_funding_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def post_instrument_with_http_info(
        self,
        request_body: Dict[str, Any],
        replace: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def post_instrument_without_preload_content(
        self,
        request_body: Dict[str, Any],
        replace: Optional[StrictBool] = None,
        _request_timeout: Union[
